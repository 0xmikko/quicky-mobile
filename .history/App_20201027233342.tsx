...
const App = () => {
  useEffect(() => {
    GoogleSignin.configure({
      ...
      iosClientId: 'com.googleusercontent.apps.372309546970-obgomvqh17flsk2nno61lqd1v0pk5023', // [iOS] optional, if you want to specify the client ID of type iOS (otherwise, it is taken from GoogleService-Info.plist)
    });
    console.log('HUEVA');
  }, []);
