...
const App = () => {
  useEffect(() => {
    GoogleSignin.configure({
      ...
      iosClientId: '372309546970-obgomvqh17flsk2nno61lqd1v0pk5023.apps.googleusercontent.com', // [iOS] optional, if you want to specify the client ID of type iOS (otherwise, it is taken from GoogleService-Info.plist)
    });
    console.log('HUEVA');
  }, []);
